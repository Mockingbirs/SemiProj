...
<div class = "outline">
<form action="signUp-user.jsp" name="form" method="post">
...
- 생성정보 수집 툴을 통한 수집
  ...
  <tr>
   <td align="center" valign="top">
    <input class="checkbutton" type="button" value="동의" onclick="chk()"/>&nbsp;&nbsp;&nbsp;
    <input class="checkbutton" type="button" value="비동의" onclick="nochk()"/>
   </td>
  </tr>
 </table>
</form>
