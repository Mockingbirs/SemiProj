...
<form name="#" class="mjoin_form form" action="#" method="post">
	...
	<div class="mjoin">
		<div class="mjoinlayout">
			<!-- ◆공통페이지 타이틀 -->
			<div class="m_page">
				<div class="title">내 정보◕‿◕✿</div>
			</div>
			<!-- /공통페이지 타이틀 -->
<br>

			<!-- ◆정보입력 -->
			<div class="m_join_tit"><span class="tit">기본정보</span><br><span class="sub_txt">정보 수정 후 수정하기 버튼을 누르시면 정보가 수정됩니다.✪‿✪</span></div>
			<div class="m_form">
				<table>
					<colgroup>
					...
					<tbody>
						<tr>
							<th class="ess"><span class="tit">내 아이디</span></th>
							<td colspan="3">
								<div class="input_box">
									<span>id 받아오기(백엔드)</span>
						...
						<tr>
							...
							<td>
								...
								<div class="tip_txt ">
									숫자, 영문을 포함하여 4자 이상 입력해주세요. 신중하게 바꿔주시기 바랍니다.								</div>
							</td>
