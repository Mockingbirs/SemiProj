  ...
  <div class= "signintop">
	...
	<div class= "usersignin">
		...
		<form action="blogin.me" method="post">
  		  	 <div class="">
      			<input type="text" class="form-control" id="" name="bm_id" placeholder="기업 아이디">
    		 </div>
    		 <div class="">
      			<input type="password" class="form-control" id="" name="bm_password" placeholder="기업 비밀번호">    		
    		</div>
			<br>
    		<button id="signIn" class="signinbutton" type="submit">로그인</button>
    		<br>
    		<button id="singUp" class="signinbutton"  type="button" onclick= "location.href='entryinfo.do'">입점문의</button>
   			<br>
   			<button id="singUp" class="signinbutton"  type="button" onclick= "location.href='bidpsfind.me'">아이디/비밀번호 찾기</button>
 		 </form>
	</div>
